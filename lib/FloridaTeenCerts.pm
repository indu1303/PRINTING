...
LETTER
    ...
    my $email = MIME::Lite->new(From => 'I DRIVE SAFELY - Customer Service <wecare@idrivesafely.com>',
                                ...
                                Subject => "Teen Florida Web Service Truncation:  UserId:  $userId",
...
LETTER
        ...
        my $email = MIME::Lite->new(From => 'I DRIVE SAFELY - Customer Service <wecare@idrivesafely.com>',
                                    To => 'supportmanager@idrivesafely.com',
                                    Subject => "Teen Florida Web Service Error:  UserId:  $userId",
                                    Type => 'multipart/related'
                                    );
...
my $PASSWORD            = 'Traffic3000';
    use SOAP::Lite;
    my $soap =  SOAP::Lite
    ->service("$printerSite::SITE_PROD_TEEN_URL/wsPrimerComponent_1.wsdl")
    ->wsVerifyData(
