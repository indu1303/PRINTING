...
my $NO_PRINT_TEEN_COURSE = { map { $_ => 1 } qw(5001 5002 5003 11003 10006 10007 10008 5013) };
=pod
...
{
    my $self = shift;
    my $product =($self->{PRODUCT})?$self->{PRODUCT}:'AAATEEN';
...
sub getNextCertificateNumber
{
	...
	if($cId eq  '10006')
	{
        ...
        elsif ($cId == 5001 || $cId == 5002 || $cId == 5003 || $cId == 5013)
    	{
